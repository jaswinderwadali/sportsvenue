...
public class Upload_Image extends AsyncTask {
	...
	public Upload_Image(File file, Context context, String user_id,
			String gropname, String aboutgrup, String pub, String catagory,
			String uniqueid, String filename, String latitude, String longitude) {
		this.fileName = filename;
		this.gropname = gropname;
		this.aboutgrup = aboutgrup;
		this.pub = pub;
	...
	protected Object doInBackground(Object... params) {
		...
		try {
			...
			dos.writeBytes(twoHyphens + boundary + lineEnd);
			dos.writeBytes("Content-Disposition: form-data; name=\"group_name\""
					+ lineEnd);
			dos.writeBytes(lineEnd);

			// assign value
			dos.writeBytes(gropname);
			dos.writeBytes(lineEnd);
			dos.writeBytes(twoHyphens + boundary + lineEnd);

			dos.writeBytes(twoHyphens + boundary + lineEnd);
			dos.writeBytes("Content-Disposition: form-data; name=\"group_about\""
					+ lineEnd);
			dos.writeBytes(lineEnd);

			// assign value
			dos.writeBytes(aboutgrup);
			dos.writeBytes(lineEnd);
			dos.writeBytes(twoHyphens + boundary + lineEnd);
